...
namespace xRoadMap.Module.BusinessObjects.cspra
{
    public static class ConnectionHelper
    {
        static Type[] persistentTypes = new Type[] {
            typeof(cspraEvento),
            typeof(cspraEventoOnRoad),
            typeof(cspraRoad),
            typeof(cspraTombino),
            typeof(cspraEnum),
            typeof(cspraPonte),
            typeof(CSPRA_RDSEVENTSPOINTS),
            typeof(CSPRA_RDSEVENTSPOLYLINES)
        };
        ...
        public static string ConnectionString { get { return System.Configuration.ConfigurationManager.ConnectionStrings["cspra"].ConnectionString; } }
